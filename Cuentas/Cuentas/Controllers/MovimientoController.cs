            ...
            if (ModelState.IsValid)
            {
                ...
                if (cuenta != null)
                {
                    if (cuenta.balance < 0)
                    {
                        ...
                        TempData["Error"] = "La cuenta está inactiva debido a saldo negativo y no puede procesar movimientos.";
                    ...
                    else 
                    {
                        ...
                        {
                            TempData["Error"] = "Fondos insuficientes para realizar el retiro.";
                            return RedirectToAction(nameof(Index));
                        }
